...
import nettion.features.module.modules.ghost.HitBox;
import nettion.features.module.modules.movement.Scaffold;
import nettion.features.module.modules.ghost.SafeWalk;
...
import net.minecraft.util.Vec3f;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = this.onGround && this.isSneaking() && this instanceof EntityPlayer || Nettion.instance.getModuleManager().getModuleByClass(SafeWalk.class).isEnabled() && this.onGround;
            boolean ScaffoldFlag = this.onGround && this.isSneaking() && this instanceof EntityPlayer || (Nettion.instance.getModuleManager().getModuleByClass(Scaffold.class).isEnabled() && Scaffold.safe.getValue());

            if (flag || ScaffoldFlag)
            {
                double d6;
            ...
            if (this.canTriggerWalking() && !(flag || ScaffoldFlag) && this.ridingEntity == null)
            {
    ...
    public float getCollisionBorderSize() {
        if (Nettion.instance.getModuleManager().getModuleByClass(HitBox.class).isEnabled()) {
