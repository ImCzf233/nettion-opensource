...
import nettion.event.events.world.EventLivingUpdate;
...
public abstract class EntityLivingBase extends Entity
{
    ...
    protected final Map<Integer, PotionEffect> activePotionsMap = Maps.<Integer, PotionEffect>newHashMap();
    ...
    protected void jump()
    {
        if (this instanceof EntityPlayerSP) {
            final EventJump event = new EventJump((float) motionY, Minecraft.getMinecraft().thePlayer.renderYawOffset);
            new EventBus().call(event);
