...
import nettion.features.module.modules.render.XRay;
...
public class Block
{
    ...
    {
        if (Nettion.instance.getModuleManager().getModuleByClass(XRay.class).isEnabled()) {
            return this == getBlockById(56)
