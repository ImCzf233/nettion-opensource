...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (net.optifine.Matrix4f)Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[] {this}): new net.optifine.Matrix4f();
    }
