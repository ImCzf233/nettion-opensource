...
import nettion.features.module.modules.world.MemoryFix;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public int getLimitFramerate() {
        return this.theWorld == null && this.currentScreen != null ? 1999999999 : this.gameSettings.limitFramerate;
    }
    ...
    public void runTick() throws IOException {
        if (this.thePlayer != null) {
            if (ModuleManager.getModuleByClass(MemoryFix.class).isEnabled() && MemoryFix.mode.getValue() == MemoryFix.modes.Advanced && MemoryFix.onlyUseSystemGC.getValue()) {
                long maxmem = Runtime.getRuntime().maxMemory();
                long totalmem = Runtime.getRuntime().totalMemory();
                long freemem = Runtime.getRuntime().freeMemory();
                long usemem = totalmem - freemem;
                float pct = (float)(usemem * 100L) / (float)maxmem;
                TimerUtils timerFree = new TimerUtils();
