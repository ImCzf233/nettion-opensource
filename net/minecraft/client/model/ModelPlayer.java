...
import nettion.features.module.modules.render.Wings;
...
public class ModelPlayer extends ModelBiped
{
    ...
    boolean flying;
    private final ResourceLocation texture = new ResourceLocation("nettion/wings.png");
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale)
    {
        ...
        else
        {
            ...
            // Wings
            if (ModuleManager.getModuleByClass(Wings.class).isEnabled() && entityIn == Minecraft.getMinecraft().thePlayer) {
                EntityPlayer player = Minecraft.getMinecraft().thePlayer;

                if (player.isInvisible())
                    return;
                this.renderWings(player, p_78088_3_, p_78088_4_, scale);
            }
        }
    ...
    // Wings
    private void renderWings(EntityPlayer player, float p_78088_3_, float p_78088_4_, float scale) {
