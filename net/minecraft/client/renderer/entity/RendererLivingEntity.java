...
import nettion.features.module.modules.render.Chams;
import nettion.features.module.modules.render.ESP;
import nettion.features.module.modules.render.MobendsMOD;
...
import nettion.features.module.modules.render.NameTags;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        {
            if (((MobendsMOD) ModuleManager.getModuleByClass(MobendsMOD.class)).onRenderLivingEvent(this, entity, x, y, z, entityYaw, partialTicks)) {
                return;
            }
            ...
            try
            {
                ...
                float f7;
                f7 = entity == this.renderManager.livingPlayer ? entity.prevRotationPitchHead + (entity.rotationPitchHead - entity.prevRotationPitchHead) * partialTicks : entity.prevRotationPitch + (entity.rotationPitch - entity.prevRotationPitch) * partialTicks;
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor)
    {
        ...
        if (flag || flag1)
        {
            ...
            if (Nettion.instance.getModuleManager().getModuleByClass(Chams.class).isEnabled() && entitylivingbaseIn instanceof EntityPlayer) {
                RenderUtils.pre();
                GL11.glDisable(2896);
    ...
    {
        if ((Nettion.instance.getModuleManager().getModuleByClass(ESP.class).isEnabled() || Nettion.instance.getModuleManager().getModuleByClass(NameTags.class).isEnabled()) && entity instanceof EntityPlayer) {
            return;
        }
