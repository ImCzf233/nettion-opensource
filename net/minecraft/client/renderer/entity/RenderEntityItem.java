...
import nettion.features.module.modules.render.ItemPhysics;
import nettion.features.module.modules.render.NoRender;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    private int func_177077_a(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_) {
        ...
        if (Nettion.instance.getModuleManager().getModuleByClass(ItemPhysics.class).isEnabled()) {
    ...
    {
        if (Nettion.instance.getModuleManager().getModuleByClass(NoRender.class).isEnabled()) {
            return;
        }
