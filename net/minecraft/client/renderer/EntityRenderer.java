...
import nettion.features.module.modules.render.CameraClip;
import nettion.features.module.modules.render.NoFov;
import nettion.features.module.modules.render.Zoom;
...
import nettion.event.events.render.EventWorldRender;
import nettion.features.module.modules.ghost.Reach;
import nettion.features.module.modules.render.NoHurtCam;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            double d0;
            if (Nettion.instance.getModuleManager().getModuleByClass(Reach.class).isEnabled()) {
                d0 = Reach.reach.getValue();
            } else {
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > (((Reach)Nettion.instance.getModuleManager().getModuleByClass(Reach.class)).isEnabled() ? Reach.reach.getValue() : 3.0))
            {
                this.pointedEntity = null;
    ...
    private void updateFovModifierHand()
    {
        ...
        if (ModuleManager.getModuleByClass(NoFov.class).isEnabled()) {
            this.fovModifierHand = NoFov.fov.getValue().floatValue();
        }
    }
    ...
    private float getFOVModifier(float partialTicks, boolean useFOVSetting)
    {
        ...
        else
        {
            ...
            if (flag) {
                ...
                if (Nettion.instance.getModuleManager().getModuleByClass(Zoom.class).isEnabled()) {
                    if (Config.zoomMode) {
                        fto = 4.0F;
                    } else {
                        fto = 1.0f;
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (!Nettion.instance.getModuleManager().getModuleByClass(NoHurtCam.class).isEnabled()) {
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (movingobjectposition != null)
                    {
                        ...
                        if (d7 < d3)
                        {
                            if (!Nettion.instance.getModuleManager().getModuleByClass(CameraClip.class).isEnabled()) {
                                d3 = d7;
                            }
                        }
                    }
