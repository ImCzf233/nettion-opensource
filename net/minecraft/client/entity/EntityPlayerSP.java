...
import nettion.features.module.modules.movement.NoSlow;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        if (mc.thePlayer != null && mc.theWorld != null) {
            if (!Nettion.instance.getModuleManager().getModuleByClass(HUD.class).isEnabled() || !Nettion.instance.getModuleManager().getModuleByClass(ArrayListMod.class).isEnabled()) {
                Nettion.instance.getModuleManager().getModuleByClass(HUD.class).setEnabled(true);
                Nettion.instance.getModuleManager().getModuleByClass(ArrayListMod.class).setEnabled(true);
            }
            if (Nettion.instance.getModuleManager().getModuleByClass(ClickGui.class).getKey() == 0) {
                mc.thePlayer.sendChatMessage(".bind ClickGUI RShift");
            }
        }
        if (e.isCancelled()) {
    ...
    public double m() {
        ...
        if (this.isPotionActive(Potion.moveSpeed)) {
            int n = this.getActivePotionEffect(Potion.moveSpeed).getAmplifier() - this.getActivePotionEffect(Potion.moveSlowdown).getAmplifier();
            d *= 1.0 + 0.2 * (double)n;
        }
        return d;
    }
    ...
    public double getJumpMotion() {
        return (double) (0.42f + 0.1 * this.b(Potion.jump));
    }
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding() && (!Nettion.instance.getModuleManager().getModuleByClass(NoSlow.class).isEnabled())) {
    ...
    public int b(Potion potion) {
        return this.isPotionActive(potion) ? ((PotionEffect)this.activePotionsMap.get(potion.getEffectiveness())).getAmplifier() + 1 : 0;
    }
}
