...
public class LoadConfig {
    ...
    static {
        ...
        LoadConfig.dir = new File(mcDataDir, "Nettion/Config");
    }
    ...
    public static void init() {
        if (!LoadConfig.dir.exists()) {
            LoadConfig.dir.mkdir();
        }
    }
    ...
    public static List<String> read(final String file) {
        ...
        try {
            ...
            final File f = new File(LoadConfig.dir, file);
            if (!f.exists()) {
                f.createNewFile();
            }
            Throwable t = null;
