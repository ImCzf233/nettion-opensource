...
public class Button {
    ...
    public void render(int mouseX, int mouseY) {
        ...
        Gui.drawRect(this.x - 5, this.y - 5, this.x + 85, this.y + Fonts.PF18.getStringHeight(this.cheat.getName()) + 2, ClientUtil.reAlpha(1, 0.5f));
        if (mouseX > this.x - 7 && mouseX < this.x + 85 && mouseY > this.y - 6
                && mouseY < this.y + Fonts.PF18.getStringHeight(this.cheat.getName()) + 4) {
            Gui.drawRect(this.x - 5, this.y - 5, this.x + 85, this.y + Fonts.PF18.getStringHeight(this.cheat.getName()) + 2, ClientUtil.reAlpha(1, 0.5f));

        }
        if (this.cheat.isEnabled()) {
            Fonts.PF18.drawString(this.cheat.getName(), this.x + 5, this.y, new Color(0x00A6FF).getRGB());
        } else {
            Fonts.PF18.drawString(this.cheat.getName(), this.x + 5, this.y, new Color(255, 255, 255).getRGB());
        }
