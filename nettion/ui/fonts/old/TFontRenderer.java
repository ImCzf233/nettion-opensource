...
public class TFontRenderer
extends TFont {
    protected TFont.CharData[] boldChars = new TFont.CharData[256];
    protected TFont.CharData[] italicChars = new TFont.CharData[256];
    protected TFont.CharData[] boldItalicChars = new TFont.CharData[256];
    ...
    public float drawString(String text, double x, double y, int color, boolean shadow) {
        ...
        TFont.CharData[] currentData = this.charData;
