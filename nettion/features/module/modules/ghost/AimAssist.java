...
extends Module {
    ...
    public AimAssist() {
        super("AimAssist", ModuleType.Ghost);
    ...
    public void onUpdate(EventPreUpdate event) {
        ...
        if (mc.thePlayer.getHeldItem() == null && ((Boolean)this.held.getValue()).booleanValue()) {
            return;
        }
        Entity entity = null;
        ...
        for (Entity e : mc.theWorld.getLoadedEntityList()) {
            if (e == mc.thePlayer || !this.isValid(e)) continue;
            yawdistance = this.getDistanceBetweenAngles(this.getAngles(e)[1], mc.thePlayer.rotationYaw);
        ...
        if (entity != null) {
            ...
            yawdistance = this.getDistanceBetweenAngles(yaw, mc.thePlayer.rotationYaw);
            double pitchdistance = this.getDistanceBetweenAngles(pitch, mc.thePlayer.rotationPitch);
    ...
    public Object[] getEntity(double distance, double expand) {
        ...
        if (var2 != null) {
            if (mc.theWorld != null) {
                ...
                Vec3 var10 = null;
                float var11 = 1.0f;
                List<Entity> var12 = mc.theWorld.getEntitiesWithinAABBExcludingEntity(var2, var2.getEntityBoundingBox().addCoord(var8.xCoord * var3, var8.yCoord * var3, var8.zCoord * var3).expand(var11, var11, var11));
                double var13 = var5;
                for (Entity o : var12) {
                    double var20;
    ...
    public boolean isValid(Entity e) {
        boolean flag1 = true;
        Module ab2 = Nettion.instance.getModuleManager().getModuleByClass(AntiBot.class);
        if (ab2.isEnabled() && ab2.isEnabled()) {
            flag1 = !AntiBot.isServerBot((EntityLivingBase)e);
        }
        ...
        if ((double)mc.thePlayer.getDistanceToEntity(e) > (Double)this.Range.getValue()) return false;
        if (e.getName().contains("#")) return false;
        if (((Boolean)this.team.getValue()).booleanValue()) {
            if (e.getDisplayName().getFormattedText().startsWith("\u00a7" + mc.thePlayer.getDisplayName().getFormattedText().charAt(1))) return false;
        }
