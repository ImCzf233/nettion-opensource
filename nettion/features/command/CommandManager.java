 ...
 */
package nettion.features.command;

import nettion.Nettion;
import nettion.features.command.commands.*;
import nettion.event.EventBus;
import nettion.event.EventHandler;
import nettion.event.events.misc.EventChat;
import nettion.other.Manager;
import nettion.features.module.modules.player.NoCommand;
...
implements Manager {
    ...
    private void onChat(EventChat e) {
        if (!Nettion.instance.getModuleManager().getModuleByClass(NoCommand.class).isEnabled()) {
