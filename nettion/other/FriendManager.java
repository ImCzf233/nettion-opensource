...
public class FriendManager implements Manager {
   ...
   public void init() {
      ...
      Nettion.instance.getCommandManager().add(new FriendManager$1(this, "f", new String[]{"friend", "fren", "fr"}, "add/del/list name alias", "Manage client friends"));
   }
   ...
   static HashMap access$0() {
	...
	static class FriendManager$1 extends Command {
