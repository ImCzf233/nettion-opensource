package nettion.other.mobends.data;

import java.util.ArrayList;
import java.util.List;

import nettion.other.mobends.client.model.ModelRendererBends;
import nettion.other.mobends.client.model.entity.ModelBendsPlayer;
import nettion.other.mobends.client.renderer.SwordTrail;
import nettion.other.mobends.util.SmoothVector3f;
				...
				if(this.currentAttack == 0){
					...
					if(this.ticksAfterPunch < 15.0f){
						if(this.currentAttack == 1) this.currentAttack = 2;
							...
							this.currentAttack = (!((MobendsMOD) ModuleManager.getModuleByClass(MobendsMOD.class)).spinAttack.getValue() || this.getEntity().isRiding()) ? 1 : 3;
						}
