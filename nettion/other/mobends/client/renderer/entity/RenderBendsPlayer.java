package nettion.other.mobends.client.renderer.entity;

import nettion.other.mobends.client.model.entity.ModelBendsPlayer;
import nettion.other.mobends.client.renderer.entity.layers.LayerBendsCape;
import nettion.other.mobends.client.renderer.entity.layers.LayerBendsCustomHead;
import nettion.other.mobends.client.renderer.entity.layers.LayerBendsPlayerArmor;
...
public class RenderBendsPlayer extends RenderPlayer {
    ...
    protected void preRenderCallback(AbstractClientPlayer p_77041_1_, float p_77041_2_) {
        ...
        if (((MobendsMOD) ModuleManager.getModuleByClass(MobendsMOD.class)).swordTrail.getValue()) {
			GL11.glPushMatrix();
				float f5 = 0.0625F;
