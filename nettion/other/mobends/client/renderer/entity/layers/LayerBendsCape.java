package nettion.other.mobends.client.renderer.entity.layers;
...
import nettion.features.module.modules.render.Cape;
...
public class LayerBendsCape implements LayerRenderer<AbstractClientPlayer>
{
    ...
    {
        if (entitylivingbaseIn.hasPlayerInfo() && !entitylivingbaseIn.isInvisible() && entitylivingbaseIn.isWearing(EnumPlayerModelParts.CAPE) && entitylivingbaseIn.getLocationCape() != null && !ModuleManager.getModuleByClass(Cape.class).isEnabled())
        {
