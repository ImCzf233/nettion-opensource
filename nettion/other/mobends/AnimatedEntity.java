package nettion.other.mobends;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;
import com.google.common.collect.Maps;
import nettion.other.mobends.animation.Animation;
import nettion.other.mobends.animation.player.*;
import nettion.other.mobends.animation.spider.Animation_Jump;
import nettion.other.mobends.animation.spider.Animation_OnGround;
import nettion.other.mobends.animation.spider.Animation_WallClimb;
import nettion.other.mobends.animation.zombie.Animation_Stand;
import nettion.other.mobends.animation.zombie.Animation_Walk;
...
import nettion.other.mobends.util.BendsLogger;
...
public class AnimatedEntity {
	...
	public static void register() {
		...
		registerEntity(new AnimatedEntity("player","Player",Minecraft.getMinecraft().thePlayer,EntityPlayer.class,new RenderBendsPlayer(Minecraft.getMinecraft().getRenderManager())).
			add(new nettion.other.mobends.animation.player.Animation_Stand()).
			add(new nettion.other.mobends.animation.player.Animation_Walk()).
			add(new Animation_Sneak()).
			add(new Animation_Sprint()).
			add(new nettion.other.mobends.animation.player.Animation_Jump()).
